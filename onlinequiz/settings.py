...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'pubuduweerasekara82@gmail.com'       # this email will be used to send emails
EMAIL_HOST_PASSWORD = '2485-2597-A4Vc'                  # host email password required - need to encrypt later
